...
// Fake Reply Bang:)
    const ftroli = {
      key: {
        ...
        remoteJid: "6285766454089-1604595598@g.us",
      },
      message: {
        orderMessage: {
          itemCount: 10,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6285766454089-1616169743@g.us",
    ...
    const fvn = {
      key: {
        ...
        ...(from ? { remoteJid: "6285766454089-1613049930@g.us" } : {}),
      },
      message: {
        audioMessage: {
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "6285766454089-1613049930@g.us",
      "fromMe": false,
      ...
      itsmevall.sendMessage(from, teks, text, {
        quoted: {
          key: {
            fromMe: false,
            participant: `0@s.whatsapp.net`,
            ...(from ? { remoteJid: "6285766454089-1604595598@g.us" } : {}),
          },
          message: {
            imageMessage: {
              url: "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6285766454089-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Argio Dev`, "footerText": "*_© Dcode Denpa_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊??𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢??𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @𝙣𝙣𝙙𝙖.𝙠𝙧𝙣𝙬𝙣_ ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
